...
class IndividualPageForDoctor extends StatefulWidget {
  // IndividualPageForDoctor({Key key, this.chatModel, this.sourchat}) : super(key: key);
  // IndividualPageForDoctor({Key ? key, required this.chatModel, required this.sourchat}) : super(key: key);
  // const IndividualPageForDoctor({Key ? key, required this.chatModel,}) : super(key: key);
  // final ChatModel chatModel;
  static const String routeName = '/individualPage';
  // final Doctor doctor;
  
  //  IndividualPageForDoctor({Key ? key, required this.doctor, required doctor_id,}) : super(key: key);
  
  const IndividualPageForDoctor({
    Key? key,
  ...
  @override
  _IndividualPageForDoctorState createState() => _IndividualPageForDoctorState();
}

class _IndividualPageForDoctorState extends State<IndividualPageForDoctor> {
