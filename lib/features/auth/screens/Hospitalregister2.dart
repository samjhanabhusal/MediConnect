...
class HospitalRegister extends StatefulWidget {
  HospitalRegister({Key? key, required this.name}) : super(key: key);
  final String name;
  @override
          ...
          child: Form(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                //     builder: (context) => HospitalRegistrationDetails(
                //           confirmpassword: _confirmpasswordController.text,
                //           email: _emailController.text,
                //           name: widget.name,
                //           phone: _phoneController.text,
...
//                   CustomButton(
//                       text: 'Done',
//                       onTap: () { if (_registeHospitalFormKey.currentState!.validate()) {
//                               signUpDoctor();
//                             }
