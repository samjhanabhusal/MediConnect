...
class doctorindividual extends StatefulWidget {
  static const String routeName = '/doctorindividual';
  const doctorindividual({Key? key}) : super(key: key);

  @override
  State<doctorindividual> createState() => _doctorindividualState();
}
