...
class VentilatorBeds extends StatefulWidget {
  const VentilatorBeds({Key? key}):super(key: key);

  @override
  State<VentilatorBeds> createState() => _VentilatorBedsState();
}

class _VentilatorBedsState extends State<VentilatorBeds> {
  //  var hospital_list = [
  //   {
...
var hospital_list = [
  ...
  //   bedds = await hospitalService.fetchAllBeds(context);
  //   setState(() {});
  // }
...
//                                             Text(
//                                               "\ $ventilators_available Bed(s) available",
//                                               style: TextStyle(
